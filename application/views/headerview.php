...
<title>Acme Co - <?php echo $page_title;?></title>
...
<body>
<h3 class="left"><?php echo anchor(base_url().'', 'New reservation', 'title="New reservation"'); ?></h3>
<h3 class="right">Ticket Reservation</h3>
<div id="page-wrap">
    <div id="text-message">
        <?php
