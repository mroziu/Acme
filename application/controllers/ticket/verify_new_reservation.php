...
class Verify_New_Reservation extends CI_Controller {
    ...
    function index() {
        ...
        $this->form_validation->set_rules('adulttickets', 'Adult tickets', 'trim|required|is_natural|min_length[1]|max_length[2]|xss_clean');
        $this->form_validation->set_rules('childtickets', 'Child tickets', 'trim|required|is_natural|min_length[1]|max_length[2]|xss_clean');
        $this->form_validation->set_rules('seniortickets', 'Senior tickets', 'trim|required|is_natural|min_length[1]|max_length[2]|xss_clean|callback__checkmaxticketallowed');
